...
export function MovieWatchProviders200ResponseResultsBBFlatrateInnerToJSON(json: any): MovieWatchProviders200ResponseResultsBBFlatrateInner {
    return MovieWatchProviders200ResponseResultsBBFlatrateInnerToJSONTyped(json, false);
}

export function MovieWatchProviders200ResponseResultsBBFlatrateInnerToJSONTyped(value?: MovieWatchProviders200ResponseResultsBBFlatrateInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
