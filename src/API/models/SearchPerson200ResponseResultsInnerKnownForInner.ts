...
export function SearchPerson200ResponseResultsInnerKnownForInnerToJSON(json: any): SearchPerson200ResponseResultsInnerKnownForInner {
    return SearchPerson200ResponseResultsInnerKnownForInnerToJSONTyped(json, false);
}

export function SearchPerson200ResponseResultsInnerKnownForInnerToJSONTyped(value?: SearchPerson200ResponseResultsInnerKnownForInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
