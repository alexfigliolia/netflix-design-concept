...
export function TvSeriesWatchProviders200ResponseResultsBGFlatrateInnerToJSON(json: any): TvSeriesWatchProviders200ResponseResultsBGFlatrateInner {
    return TvSeriesWatchProviders200ResponseResultsBGFlatrateInnerToJSONTyped(json, false);
}

export function TvSeriesWatchProviders200ResponseResultsBGFlatrateInnerToJSONTyped(value?: TvSeriesWatchProviders200ResponseResultsBGFlatrateInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
