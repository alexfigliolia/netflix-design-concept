 ...
 */
export function instanceOfMovieWatchProviders200ResponseResultsTW(value: object): value is MovieWatchProviders200ResponseResultsTW {
    return true;
}
...
export function MovieWatchProviders200ResponseResultsTWToJSON(json: any): MovieWatchProviders200ResponseResultsTW {
    return MovieWatchProviders200ResponseResultsTWToJSONTyped(json, false);
}

export function MovieWatchProviders200ResponseResultsTWToJSONTyped(value?: MovieWatchProviders200ResponseResultsTW | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
