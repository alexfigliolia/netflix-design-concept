 ...
 */
export function instanceOfMovieWatchProviders200ResponseResultsGT(value: object): value is MovieWatchProviders200ResponseResultsGT {
    return true;
}
...
export function MovieWatchProviders200ResponseResultsGTToJSON(json: any): MovieWatchProviders200ResponseResultsGT {
    return MovieWatchProviders200ResponseResultsGTToJSONTyped(json, false);
}

export function MovieWatchProviders200ResponseResultsGTToJSONTyped(value?: MovieWatchProviders200ResponseResultsGT | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
